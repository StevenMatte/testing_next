...
// Fetches fresh data from the server on every request.
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {moviesList.map((movie) => (
            <div key={movie.id}>
              <Link href={`/hybrid/ssr/${movie.id}`} key={movie.id} className="block bg-dark-100 rounded shadow p-4 transition-transform transform hover:scale-105 hover:shadow-lg">
